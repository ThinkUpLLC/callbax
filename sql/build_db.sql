--
-- Table structure for table 'cb_callbacks'
--

CREATE TABLE cb_callbacks (
...
--
-- Table structure for table 'cb_installations'
--

CREATE TABLE cb_installations (
  id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Internal unique ID',
...
CREATE TABLE cb_users (
  ...
  follower_count int(11) NOT NULL DEFAULT '0' COMMENT 'Total number of user followers/subscribers/friends.',
