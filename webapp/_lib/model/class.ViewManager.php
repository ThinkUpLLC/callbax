...
/**
 *
 * ThinkUp/webapp/_lib/model/class.ViewManager.php
 *
 ...
 *
 * Configures and initalizes Smarty per Callbax' configuration.
 *
...
class ViewManager extends Smarty {
    ...
    public function __construct($config_array=null) {
        ...
        $this->compile_dir = WEBAPP_PATH.'_lib/view/compiled_view/';
        $this->plugins_dir = array('plugins', WEBAPP_PATH.'_lib/view/plugins/');
        $this->cache_dir = WEBAPP_PATH.'_lib/view/compiled_view/cache';
    ...
    public function fetch($template, $cache_key=null, $compile_id=null, $display=false) {
        if (! is_writable($this->compile_dir) || ! is_writable($this->compile_dir.'/cache') ) {
            ...
            array(BASE_URL, $whoami, $this->compile_dir),
