<?php /* Smarty version 2.6.26, created on 2011-09-30 15:55:06
...
+<?php echo ((is_array($_tmp='(')) ? $this->_run_mod_handler('urlencode', true, $_tmp) : urlencode($_tmp)); ?>
<?php echo $this->_tpl_vars['stat']['percentage']; ?>
<?php echo ((is_array($_tmp='%)')) ? $this->_run_mod_handler('urlencode', true, $_tmp) : urlencode($_tmp)); ?>
...
<br style="clear:both">
<br><br>
<?php if ($this->_tpl_vars['usercount_stats']): ?>
Service user count distribution<br />
<img src="http://chart.apis.google.com/chart?cht=p&chd=t:<?php $_from = $this->_tpl_vars['usercount_stats']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['sloop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['sloop']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['skey'] => $this->_tpl_vars['stat']):
        $this->_foreach['sloop']['iteration']++;
?><?php echo $this->_tpl_vars['stat']['percentage']; ?>
<?php if (! ($this->_foreach['sloop']['iteration'] == $this->_foreach['sloop']['total'])): ?>,<?php endif; ?><?php endforeach; endif; unset($_from); ?>&chs=400x200&chl=<?php $_from = $this->_tpl_vars['usercount_stats']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['sloop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['sloop']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['skey'] => $this->_tpl_vars['stat']):
        $this->_foreach['sloop']['iteration']++;
?><?php echo $this->_tpl_vars['stat']['user_count']; ?>
+user<?php if ($this->_tpl_vars['stat']['user_count'] > 1): ?>s<?php endif; ?>+<?php echo ((is_array($_tmp='(')) ? $this->_run_mod_handler('urlencode', true, $_tmp) : urlencode($_tmp)); ?>
<?php echo $this->_tpl_vars['stat']['percentage']; ?>
<?php echo ((is_array($_tmp='%)')) ? $this->_run_mod_handler('urlencode', true, $_tmp) : urlencode($_tmp)); ?>
<?php if (! ($this->_foreach['sloop']['iteration'] == $this->_foreach['sloop']['total'])): ?>|<?php endif; ?><?php endforeach; endif; unset($_from); ?>&chco=6184B5,E6E6E6"/>
<?php endif; ?>
