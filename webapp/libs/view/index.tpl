...
{foreach from=$installations key=ikey item=installation name=iloop}
    <tr style="border-top : 1px solid silver;">
        ...
        <td><h6 title="{$installation.last_seen}">{$installation.last_seen|relative_datetime} ago</td>
        <td><h6><span style="color:{$installation.version|twitter_api}">&#9679;</span> {$installation.version}</h6></td>
    </tr>
{/foreach}
</table>
